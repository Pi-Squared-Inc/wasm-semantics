...
INSTRS_CONFIG:list[InstrConfig]=[
    ...
    InstrConfig("SELECT_GENERIC", b"\x1C", ["ValTypes", ], notImplemented()),
...
def parse_rules(parser_prefix: str, items: list[InstrConfig], output_pieces: list[str]) -> None:
    ...
    output_pieces.append(f'                       | #{parser_prefix}p2(Int, BytesWithIndex)  [function, total]\n')
...
```k
module BINARY-PARSER-INSTRS-SYNTAX
